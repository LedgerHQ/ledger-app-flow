...
// Called when argumentIndex-th argument is an array. If the array length is more than
// max_number_of_items returns parser error, otherwise it sets number_of_items as the array length.
